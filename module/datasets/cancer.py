...
class CancerDataset(TorchDataset):
    def __init__(self, dataset_path, template_path=None, split="train", question_wrapper=None, tokenizer=None, **kwargs):
        ...
        self.meta_data = {
            ...
            "Degree Maligancy": "Degree of malignancy",
            "Breast": "Which breast is affected",
            "Breast Quadrant": "Quadrant of the breast affected",
            "Irradiation": "Whether the patient has received irradiation"
        }

        self.question_prefix = """You are a medical assessment assistant specializing in breast cancer prognosis. Based on the following patient description, predict whether the patient's cancer is likely to recur."""

        # self.bins = {
        #     "Age": ([-np.inf, "10-19", "20-29", "30-39", "40-49", "50-59", "60-69", "70-79", "80-89", "90-99", np.inf], ["10-19", "20-29", "30-39", "40-49", "50-59", "60-69", "70-79", "80-89", "90-99"]),
        #     "Menopause": (["lt40", "ge40", "premeno"], ["lt40", "ge40", "premeno"]),
        #     "Tumor Size": (["0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59"], ["0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59"]),
        #     "Inv Nodes": (["0-2", "3-5", "6-8", "9-11", "12-14", "15-17", "18-20", "21-23", "24-26", "27-29", "30-32", "33-35", "36-39"], ["0-2", "3-5", "6-8", "9-11", "12-14", "15-17", "18-20", "21-23", "24-26", "27-29", "30-32", "33-35", "36-39"]),
        #     "Node Caps": (["yes", "no"], ["yes", "no"]),
        #     "Degree Maligancy": ([1, 2, 3], [1, 2, 3]),
        #     "Breast": (["left", "right"], ["left", "right"]),
        #     "Breast Quadrant": (["left-up", "left-low", "right-up", "right-low", "central"], ["left-up", "left-low", "right-up", "right-low", "central"]),
        #     "Irradiation": (["yes", "no"], ["yes", "no"])
        # }
        ...
        # self.df = add_counterfactuals(self.df, self.bins, label_col="Class", r=2, m=10, eps=0.3, seed=0)
    ...
    def _load_data(self):
        ...
        for idx in range(len(self.df)):
            ...
            if self.templates:
                ...
                print("No templates provided. This is recommended only for template generation.")
                data_dict["template"] = None
                data_dict["question"] = self._format_question(self.df.iloc[idx], template="<Hint>", hint="") 
            data_dict["gt"] = "A" if self.df.iloc[idx]["Class"] == "recurrence-events" else "B"
